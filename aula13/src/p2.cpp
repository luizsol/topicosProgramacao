...
void sistema() {
	...
	while (true) {
		...
		string idPessoal, idFuncional, nome, profissao, endereco, funcao, cargo, faixaSalarial;
		string pessoas;
		...
		case 'i':
			...
			aEmpresa->inserirPessoaCadastro(idPessoal, nome, profissao, endereco, funcao, cargo, faixaSalarial);
			break;
		case 'O':
		case 'o':
			try {
