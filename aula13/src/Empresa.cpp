...
string Empresa::lerDadosAguardando() {
	return this->cadastroPessoas.lerDadosPessoas("2", C_EFUNC);
}
/**
...
void Empresa::emitirFolhaPagamento() {
	...
	cout << "Folha de Pagamento da Empresa" << this->getNome() << endl<<endl;
	float sb, cs, ir, sl, tsb =0, tcs=0, tir=0, tsl=0;

	for (unsigned long i = 0; i < this->funcionarios.size(); i++) {
		string salarioBruto = calcularSalario(this->funcionarios[i].getIdFuncional());
		float sb = stof(salarioBruto.substr(3, salarioBruto.length() - 3));

		ContribuicaoSindical contribSindical;
		cs = this->contribuicaoSindical.calcularCS(sb, this->funcionarios[i].getFuncao());
		...
		cout << "Funcionario " << this->funcionarios[i].getNome() << endl;
		cout << "idFuncional " << this->funcionarios[i].getIdFuncional() << endl;
		cout << "Salario Bruto " << "R$ " << fixed << setprecision(2) << sb << endl;
		cout << "Contribuicao Sindical " << "R$ " << fixed << setprecision(2) << cs << endl;
		cout << "Imposto de Renda " << "R$ " << fixed << setprecision(2) << ir << endl;
		cout << "Salario Liquido " << "R$ " << fixed << setprecision(2) << sl << endl << endl;
	}

	cout << "Total de Salario Bruto" << "R$ " << fixed << setprecision(2) << tsb << endl;
	cout << "Total de Contribuicao Sindical " << "R$ " << fixed << setprecision(2) << tcs << endl;
	cout << "Total de Imposto de Renda " << "R$ " << fixed << setprecision(2) << tir << endl;
	cout << "Total de Salario Liquido " << "R$ " << fixed << setprecision(2) << tsl << endl << endl;
