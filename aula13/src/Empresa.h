...
public:
  ...
  */
  ...
  /**
  Retorna os dados de todas as pessoas aguardando contratação

  @return a concatenação de todas as linhas que representam pessoas com estado 2.
  */
  string lerDadosAguardando();
  ...
  */
  ...
  /**
  Obtém a Folha de pagamento da empresa

  @return bit de confirmação da operação
  */
