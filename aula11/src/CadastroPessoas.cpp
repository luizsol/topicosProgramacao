...
bool CadastroPessoas::inserir(string idPessoal, string idFuncional, string estadoFuncional, string nome, string profissão, string endereço, string função, string cargo, string faixaSalarial, string gratificacao)
{
	string pessoa = idPessoal + "|" + idFuncional + "|" + estadoFuncional + "|" + nome + "|" + profissão + "|" + endereço + "|" + função + "|" + cargo + "|" + faixaSalarial + "|" + gratificacao + "|";
