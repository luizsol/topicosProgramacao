...
class Empresa{
  ...
  TabelaSalarial tabelaSalarial;		// Objeto de acesso à tabela salarial
...
public:
  ...
  */
  bool contratarFuncionario(string idPessoa, string idFuncional, string nome,
                            ...
                            string cargo, string faixaSalario, string gratificacao);
...
private:
  ...
  */
  ...
  float calcularSalario(string idFuncional);
};
